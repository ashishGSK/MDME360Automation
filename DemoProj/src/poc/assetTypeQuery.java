...
public class assetTypeQuery {
	...
	public void asset() throws InterruptedException
	{
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[text()='AssetType']")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[text()='Search Asset Type']")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//*[@name='queryFieldCtrl.name'])[2]")).sendKeys("ase");
		Thread.sleep(2000);
		driver.findElement(By.id("activeQuerySearch")).click();
		Thread.sleep(10000);
		Actions act=new Actions(driver);
		act.moveToElement(driver.findElement(By.xpath("(//*[@class='ui-grid-cell-contents ng-binding'])[1]"))).doubleClick().build().perform();
